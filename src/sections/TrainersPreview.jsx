          ...
          {trainers.map((trainer) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6">
                ...
                {/* Social Links */}
                <div className="flex items-center gap-3 mt-4 opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300">
                  <a
